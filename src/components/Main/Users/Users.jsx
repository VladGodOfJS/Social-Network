    ...
    <>
     ...
     <div className={s.pages}>
            ...
            {pages.map((p) => {
              ...
              return (
                <div key={p} className={props.currentPage === p && s.current_page} onClick={()=>{props.onPageChanged(p)}}>
                  {p}
                </div>
              );
            })}
            ...
            {props.users.map((users) => {
              ...
              return (
                ...
                <div className={s.users_wrapp} key={users.id}>
                  ...
                  <NavLink to={"/profile/"+users.id}> <img src={users.photos.small != null? users.photos.small: "https://okeygeek.ru/wp-content/uploads/2020/03/no_avatar.png"} alt="ava" className={s.ava}
                    /></NavLink>
                    {users.followed ? (
                      <button
                        className={s.btn}
